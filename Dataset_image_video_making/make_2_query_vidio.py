...
# make 1에서 저장한 query 이미지들을 불러와 비디오로 저장
# 이미지들은 숫자순으로 정렬하여 프레임 순서로 사용
...
# === 경로 설정 ===
image_dir = "korea_datasets/query_images"
output_dir = "korea_datasets/query_video"
os.makedirs(output_dir, exist_ok=True)

output_video = os.path.join(output_dir, f"uav_flight_row.mp4")
